...
public class E1_Country_PositionNames {
	...
	public E1_Country_PositionNames() {
		
	}

	public E1_Country_PositionNames(String countryName, String capitalName, String capitalLatitude,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		E1_Country_PositionNames other = (E1_Country_PositionNames) obj;
	...
	public String toString() {
		return "E1_Country_PositionNames [countryName=" + countryName + ", capitalName=" + capitalName
				+ ", capitalLatitude=" + capitalLatitude + ", capitalLongitude=" + capitalLongitude + ", countryCode="
				+ countryCode + ", continentName=" + continentName + "]";
	}
