...
public class Country {
	...
	public Country(String countryName, String capitalName, String capitalLatitude, String capitalLongitude,
			String countryCode, String contientName) {
		this();
	...
	public String getContientName() {
		return contientName;
	}

	public void setContientName(String contientName) {
		this.contientName = contientName;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((contientName == null) ? 0 : contientName.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (contientName == null) {
			if (other.contientName != null)
				return false;
		} else if (!contientName.equals(other.contientName))
			return false;
		if (countryCode == null) {
