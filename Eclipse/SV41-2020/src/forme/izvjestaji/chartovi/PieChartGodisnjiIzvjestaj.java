...
public class PieChartGodisnjiIzvjestaj implements ExampleChart<PieChart> {
	...
	public PieChartGodisnjiIzvjestaj(Map<Integer, Double> map) {
		this.map = map;
	}
...
//	}
	...
	public PieChart getChart() {
		...
		for (Entry<Integer, Double> entry : this.map.entrySet()) {
			chart.addSeries(IzvjestajGodisnjiPrihodiRashodi.mjeseciStr.get(entry.getKey()), entry.getValue());
		}
